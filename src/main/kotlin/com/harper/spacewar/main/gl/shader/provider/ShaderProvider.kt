...
import com.harper.spacewar.main.gl.shader.definition.ShaderDefinition
...
object ShaderProvider {
    ...
    fun <T : Shader> provide(shaderDefinition: ShaderDefinition): T {
        ...
        return kotlin.runCatching {
            shaderDefinition.scripts.map { shaderScript ->
                val shaderScriptContent =
                    fileProvider.provideFileContent(SHADERS_DIR + shaderDefinition.sourceFolder + shaderScript.name)
